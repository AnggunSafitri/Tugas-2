...
<html lang="en">
 ...
 <!-- / Cart view section -->
  ...
  <script type="{{url('public')}}/text/javascript" src="js/jquery.smartmenus.js"></script>
  <!-- SmartMenus jQuery Bootstrap Addon -->
  <script type="{{url('public')}}/text/javascript" src="js/jquery.smartmenus.bootstrap.js"></script>  
  <!-- To Slider JS -->
  <script src="{{url('public')}}/js/sequence.js"></script>
  <script src="{{url('public')}}/js/sequence-theme.modern-slide-in.js"></script>  
  <!-- Product view slider -->
  <script type="{{url('public')}}/text/javascript" src="js/jquery.simpleGallery.js"></script>
  <script type="{{url('public')}}/text/javascript" src="js/jquery.simpleLens.js"></script>
  <!-- slick slider -->
  <script type="{{url('public')}}/text/javascript" src="js/slick.js"></script>
  <!-- Price picker slider -->
  <script type="{{url('public')}}/text/javascript" src="js/nouislider.js"></script>
  <!-- Custom js -->
